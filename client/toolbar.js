...
var Toolbar = createClass({
	...
	render: function() {
		...
		return DOM.div({className:'toolbar'},[
			...
			DOM.a({href:"#",className:"btn pull-left", onClick:p.toggleCollections},
				[DOM.em({className:"fa fa-folder-o"},"")]),
			DOM.a({href:"#",className:"btn pull-left", onClick:p.toggleNotebooks},
				[DOM.em({className:"fa fa-sticky-note"},"")]),
			DOM.a({href:"#",className:"btn pull-left", onClick:p.toggleStarred},
				[DOM.em({className:"fa fa-star"},"")]),
			...
			p.editable ? DOM.a({href:"#",className:"btn pull-right", onClick:p.toggleSettings},
				[DOM.em({className:"fa fa-info-circle"},"")]) : DOM.div({}),
